...
------|---------|-----------
Webserver|[localhost:4000](http://localhost:4000)
Mailhog web interface|[localhost:4001](http://localhost:4001)
MySQL|**host:** `localhost`; **port:** `4002`
...
### Basic information...
 * cat rapido-trains.sql | docker exec -i rapido_train_mysql mysql -u {username} --password={yourpassword} {your database}
 * UPDATE `core_config_data` SET `value` = replace(value, 'http://localhost/app-name/', 'http://localhost:4000/')  
